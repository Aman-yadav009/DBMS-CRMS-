...
$sql = "select u_id,criminal_name,most_wanted from criminal where criminal_name='".$q."' and most_wanted ='YES'";
}
else
{
	"select u_id,criminal_name from criminal where criminal_name='".$q."' and most_wanted='YES'";
}
